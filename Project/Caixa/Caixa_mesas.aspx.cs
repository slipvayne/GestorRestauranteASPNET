...
public partial class Caixa_Caixa_mesas : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //criar um botao para cada mesa
            ...
            if (estado == 2)
            {
                ...
                btn.PostBackUrl = "Caixa/Caixa.aspx?mesa=" + btn.ID;
    ...
    //    Legenda.Text = "<b><font color=\"cyan\">Azul = Ocupada</font> <br/></b>";
   //     Legenda.Text += string.Format("<br/><b>Numero de mesas ocupadas(na BD):</b> {0}", num_mesas_ocupadas);
