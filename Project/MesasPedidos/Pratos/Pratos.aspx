...
<%@ Page Title="Pratos" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Pratos.aspx.cs" Inherits="Pratos"%>

<asp:Content ID="HeadCont" runat="server" ContentPlaceHolderID="HeadContent">

<title>Pratos - Gestor de Restaurante - PW/MD</title>
</asp:Content>
