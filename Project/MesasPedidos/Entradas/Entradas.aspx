...
<%@ Page Title="Entradas" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Entradas.aspx.cs" Inherits="Entradas"%>

<asp:Content ID="HeadCont" runat="server" ContentPlaceHolderID="HeadContent">

<title>Entradas - Gestor de Restaurante - PW/MD</title>
</asp:Content>
